...
// é a necessidade de implementação de uma máquina de estados.
// Geralmente, o controle das possíveis transições são vários e complexos,
// fazendo com que a implementação não seja simples.
// O State auxilia a manter o controle dos estados simples e organizados
